...
def main():
    print("🕰️ AVVIO BACKFILL: 22 Gennaio 2026 -> 24 Gennaio 2026")

    # Timezone Aware (UTC)
    start_dt = datetime(2026, 1, 25, 0, 0, 0, tzinfo=timezone.utc)
    # Impostiamo la fine a "domani" per essere sicuri di prendere tutto oggi
    end_dt = datetime(2026, 1, 27, 0, 0, 0, tzinfo=timezone.utc)
